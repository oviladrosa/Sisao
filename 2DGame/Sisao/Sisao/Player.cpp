...
enum PlayerAnims
{
	STAND_LEFT, STAND_RIGHT, MOVE_LEFT, MOVE_RIGHT, FALLING_RIGHT, FALLING_LEFT, JUMP_RIGHT_1, JUMP_RIGHT_2, JUMP_RIGHT_3, JUMP_LEFT_1, JUMP_LEFT_2, JUMP_LEFT_3, IDLE_LEFT, IDLE_RIGHT
};
